...
export const SuperAdminUpload: React.FC = () => {
  ...
  const handleDownloadTemplate = (type: 'population' | 'livedata' | 'locations' | 'vaccine_ccp') => {
    ...
    if (type === 'population') {
      ...
      headers = 'sno,countrycode,countryname,statelgdcode,statename,divisioncode,divisionname,districtlgdcode,districtname,blockorcitylgdcode,blockorcityname,areatype(blockorcity),Urbantype,HQ(Y/N),Healthblockname,population,districtthpvtarget,linelisted,vaccinated,Date(YYYY-MM-DD)\n';
