            ...
            <table className="w-full" style={{ fontSize: '11px' }}>
              <thead className="sticky top-0 z-10">
                <tr className="gradient-header text-white">
                  <th className="px-2 py-1.5 text-left font-bold uppercase tracking-wide sticky left-0 gradient-header z-20" style={{ minWidth: 140 }}>Site / Unit</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide">Annual Req.</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide">Opening Stock</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide">Vaccine Received</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide">Vaccinations</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide text-red-200">Wastage (Rep.)</th>
                  <th className="px-2 py-1.5 text-center font-bold uppercase tracking-wide">Month-end Rep. %</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide">Est. Balance</th>
                  <th className="px-2 py-1.5 text-right font-bold uppercase tracking-wide text-green-200">Actual Balance</th>
                  <th className="px-2 py-1.5 text-center font-bold uppercase tracking-wide">Wastage %</th>
                  <th className="px-2 py-1.5 text-center font-bold uppercase tracking-wide">Availability %</th>
