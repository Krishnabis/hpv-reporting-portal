  ...
  return (
    <div className="flex flex-col h-full gap-3">
      <div className="flex items-center justify-between shrink-0">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight leading-tight">HPV Vaccination — Daily Progress Report</h1>
          ...
          <table className="w-full" style={{ fontSize: '9px' }}>
            <thead className="sticky top-0 z-10">
              <tr className="gradient-header text-white shadow-sm">
                <th className="px-2 py-1.5 text-left text-[9px] font-bold uppercase tracking-wide sticky left-0 gradient-header z-20 cursor-pointer hover:bg-white/10" style={{ minWidth: 140 }} onClick={() => handleSort('name')}>Reporting Unit ({reportLevel === 'District' ? 'District' : 'Block'}){renderSortIcon('name')}</th>
                <th className="px-2 py-1.5 text-center text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('last_reporting_date')}>Last Reported{renderSortIcon('last_reporting_date')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('population')}>Population{renderSortIcon('population')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('hpv_target')}>HPV Goal{renderSortIcon('hpv_target')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('sessions_held_today')}>Sessions Today{renderSortIcon('sessions_held_today')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('vaccinated_today')}>Vaccinations Today{renderSortIcon('vaccinated_today')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('sessions_held_cumulative')}>Sessions Cumulative{renderSortIcon('sessions_held_cumulative')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('beneficiaries_vaccinated')}>Vaccinations Cumulative{renderSortIcon('beneficiaries_vaccinated')}</th>
                <th className="px-2 py-1.5 text-right text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('vaccinations_per_session')}>Vaccinations Per Session{renderSortIcon('vaccinations_per_session')}</th>
                <th className="px-2 py-1.5 text-center text-[9px] font-bold uppercase tracking-wide cursor-pointer hover:bg-white/10 border-b border-hpv-purple/40" onClick={() => handleSort('vaccination_coverage_pct')}>Goal %{renderSortIcon('vaccination_coverage_pct')}</th>
                <th className="px-2 py-1.5 text-center text-[9px] font-bold uppercase tracking-wide border-b border-hpv-purple/40">Rank</th>
              </tr>
            </thead>
            <tbody>
